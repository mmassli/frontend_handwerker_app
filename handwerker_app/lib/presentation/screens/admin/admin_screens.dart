                ...
                return SlideUpFadeIn(
                  ...
                  child: Container(
                    ...
                    child: HWInfoCard(
                      ...
                      title: 'Auftrag #${1000 + i}',
                      subtitle: 'Schlüsselnotdienst • Saarbrücken',
                      trailing: HWStatusBadge.active('Aktiv'),
                      onTap: () {},
                    ),
                  ),
                );
...
class AdminCraftsmenPanel extends ConsumerWidget {
                      ...
                      child: Row(
                        children: [
                          ...
                          HWStatusBadge(
                            ...
                            color:
                                statuses[i % statuses.length].color,
                            showDot: false,
                          ),
                        ],
                      ),
...
class AdminDisputesPanel extends ConsumerWidget {
        ...
        SliverPadding(
          ...
          sliver: SliverList(
            delegate: SliverChildBuilderDelegate(
              (context, i) {
                final statuses = [
                  ('Geöffnet', AppTheme.error),
                  ('Antwort erhalten', AppTheme.warning),
                  ('In Prüfung', AppTheme.info),
                ];
                ...
                return SlideUpFadeIn(
                  ...
                  child: TapScale(
                    onTap: () {
                      // Open dispute detail with resolution tools
                    },
                    child: Container(
                      margin: const EdgeInsets.only(bottom: 10),
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: status.$2.withOpacity(0.2),
                        ),
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Text(
                            'Auftrag #${1000 + i}: Rohrreparatur nicht fachgerecht',
                            style: const TextStyle(
                              fontFamily: AppTheme.displayFont,
                              fontSize: 14,
                              fontWeight: FontWeight.w700,
